...
export const POST = route(
  async (req: NextRequest, _ctx, user) => {
    ...
    // revistaId vem do multipart (não é param de rota): valida o ObjectId antes do Prisma.
    if (revistaId !== null && !isObjectId(revistaId)) throw ApiErrors.notFound('Revista não encontrada')
