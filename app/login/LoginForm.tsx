...
const PRODUCT_POINTS = [
  { icon: BookOpen, label: 'Estudo bíblico, meditação e exegese profunda' },
  { icon: Sparkles, label: 'Inteligência guiada pela sã doutrina' },
  { icon: ShieldCheck, label: 'Seu ministério seguro e organizado' },
]
          ...
          <div className="relative">
            <div className="inline-flex items-center gap-3">
              ...
              <div>
                ...
                <p className="eyebrow mt-0.5">O Seu Altar Digital</p>
              </div>
            </div>

            <div className="mt-16 max-w-xl">
              <p className="eyebrow mb-4 text-primary-hover">Seu ambiente de consagração</p>
              <h1 className="text-[clamp(2.6rem,5vw,4.5rem)] font-semibold leading-[0.98] tracking-[-0.055em] text-foreground">
                Estudo que se transforma em <span className="text-gradient-gold">graça e verdade.</span>
              </h1>
              <p className="mt-6 max-w-lg text-base leading-8 text-muted-foreground">
                A Palavra, seus sermões, lições e inteligência teológica unidos em um refúgio focado em equipar o seu chamado.
              </p>
            </div>
          ...
          <div className="w-full max-w-[25rem]">
            <div className="mb-9 lg:hidden">
              <div className="mb-7 inline-flex items-center gap-3">
                ...
                <div><p className="font-semibold text-foreground">Biblion</p><p className="eyebrow mt-0.5">O Seu Altar Digital</p></div>
              </div>
            </div>
